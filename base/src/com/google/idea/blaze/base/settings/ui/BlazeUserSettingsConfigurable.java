...
public class BlazeUserSettingsConfigurable extends BaseConfigurable
  ...
  public static final String ENABLE_SOURCE_AUTO_SYNC_TEXT =
  ...
  public void apply() {
    ...
    settings.setSourceAutoSync(inMemoryAutoSync.isSelected());
  ...
  public void reset() {
    ...
    inMemoryAutoSync.setSelected(settings.getSourceAutoSync());
  ...
  public boolean isModified() {
    ...
    boolean isModified =
        showBlazeConsoleOnSync.getSelectedItem() != settings.getShowBlazeConsoleOnSync()
            ...
            || inMemoryAutoSync.isSelected() != settings.getSourceAutoSync()
            || !Objects.equal(
  ...
  private JPanel getExperimentalSettingsUI() {
    ...
    inMemoryAutoSync = helper.createSearchableCheckBox(ENABLE_SOURCE_AUTO_SYNC_TEXT, true);
