...
public class BuildFileModifierImpl implements BuildFileModifier {
  ...
  private static final String ATTRIBUTE_DEPS = "deps";
  private static final String BUILDOZER_COMMAND = "buildozer";
  private static final String ADD_DEPS_COMMAND = "add deps ";
